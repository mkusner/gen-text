...
X = np.loadtxt('../../../bo_optimization_grammar/latent_features_and_targets/latent_faetures.txt')
y = -np.loadtxt('../../../bo_optimization_grammar/latent_features_and_targets/targets.txt')
y = y.reshape((-1, 1))
...
while iteration < 1000:
    ...
    sys.path.insert(0, '../../../')
    import molecule_vae
    grammar_weights = '../../../weight_files/zinc_vae_again_L56_E100_val.hdf5'
...
#    valid_smiles_final = valid_smiles_final_final
    ...
    logP_values = np.loadtxt('../../../bo_optimization_grammar/latent_features_and_targets/logP_values.txt')
    SA_scores = np.loadtxt('../../../bo_optimization_grammar/latent_features_and_targets/SA_scores.txt')
    cycle_scores = np.loadtxt('../../../bo_optimization_grammar/latent_features_and_targets/cycle_scores.txt')
